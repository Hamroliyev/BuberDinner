...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20250911151642_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuberDinner.Domain.Menu.Menu", b =>
                {
                    b.OwnsMany("BuberDinner.Domain.Dinner.ValueObjects.DinnerId", "Dinners", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("BuberDinner.Domain.Menu.Entities.MenuSection", "Sections", b1 =>
                        {
                            ...
                            b1.OwnsMany("BuberDinner.Domain.Menu.Entities.MenuItem", "MenuItems", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
                                        .HasColumnName("Id");
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuReview.ValueObjects.MenuReviewId", "MenuReviews", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
